...
#+REVEAL_HTML: <img class="stretch" src="ex1.gif">
** Issue now solved by mutexes
#+REVEAL_HTML: <img class="stretch" src="ex2.gif">
** Issue with computations after concurrent execution
#+REVEAL_HTML: <img class="stretch" src="ex3.gif">
** Issue now solved by barrier
#+REVEAL_HTML: <img class="stretch" src="ex4.gif">
